...
constexpr uint8_t CELLS_PER_REG = 3; // number of cells per register
constexpr uint8_t VREG_LEN = CELLS_PER_REG * 2; // length of voltage registers in slave (2 bytes per cell)
...
constexpr uint8_t CFG_LEN = 6; // configuration data length in bytes
